...
There are multiple design configurations for a **Common Source (CS) amplifier**. The primary design decisions involve:
...
For a basic CS amplifier:

$$|A\_v| = g\_m \\ast (R\_D \\parallel r\_0)$$



where $r\_0$ is the output resistance.



If $r\_0 \\gg R\_D$, then:



$$|A\_v| \\approx g\_m \\ast R\_D$$
...
* Increases gain
* Increases voltage drop ( I\_D \\cdot R\_D )
* Reduces available drain voltage
* Risk of leaving saturation region

#### 2\. Increasing ( I\_D ) due to increasing ( W )
...
* Not feasible in modern low-voltage IC design
...
|DC Voltage Drop|Large ( I\_D R\_D )|Small ( V\_{DS,sat} \\approx 100–200mV )|
